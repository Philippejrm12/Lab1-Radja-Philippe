...
public final class CollectionReactionHelper
{
	...
	public static ca.etsmtl.log720.lab1.CollectionReaction narrow(final java.lang.Object obj)
	{
		if (obj instanceof ca.etsmtl.log720.lab1.CollectionReaction)
		{
	...
	public static ca.etsmtl.log720.lab1.CollectionReaction narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:ca/etsmtl/log720/lab1/CollectionReaction:1.0"))
			{
